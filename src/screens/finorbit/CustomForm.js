...
const CustomForm = props =>{
    const { editable = true, disabled = false, heading = `Personal Details`, showheader = false, style, value = '', label = '', placeholder = '', onChange=() =>{}, showTopText = false} = props;
...
const styles = StyleSheet.create({
    line: {
        backgroundColor: Pref.RED, height: 1.2,
