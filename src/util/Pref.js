...
export const FinOrbitFormUrl = `https://erb.ai/corporate_tool/Apis/finorbit/`;
...
export const As26Url = `https://www.erb.ai/corporate_tool/Apis/tool_get_26as.php`;
export const CertUrl = `https://www.erb.ai/corporate_tool/Apis/tool_cert.php`;
export const PayoutUrl = `https://erb.ai/corporate_tool/Apis/tool_payout_structure.php`;
